...
const Especialidades = () => {
  ...
  const loadEspecialidades = () => {
    const data = dataService.getAll('especialidades')
  ...
  const handleSubmit = (e) => {
    ...
    if (editingItem) {
      dataService.update('especialidades', editingItem.id, formData)
    } else {
      dataService.create('especialidades', { ...formData, ativo: true })
    }
  ...
  const handleDelete = (id) => {
    if (confirm('Tem certeza que deseja excluir esta especialidade?')) {
      dataService.delete('especialidades', id)
      loadEspecialidades()
    }
  }
